...
; 0000 0115         m60 = read_adc(4);
	...
	RCALL _read_adc
	__PUTW1R 11,12
; 0000 0116         if((pm100 - 20) > m100) a = 100; else pm100 = m100;
	LDS  R26,_pm100
	LDS  R27,_pm100+1
	SBIW R26,20
	LDS  R30,_m100
...
_0x2A:
	...
	STS  _pm100,R30
	STS  _pm100+1,R31
; 0000 0117         if((pm90 - 20) > m90) { if(a==100) a= 90; else a = 80; } else pm90 = m90;
_0x2B:
	LDS  R26,_pm90
	LDS  R27,_pm90+1
	SBIW R26,20
...
_0x2C:
	...
	STS  _pm90,R30
	STS  _pm90+1,R31
; 0000 0118         if((pm80 - 20) > m80) { if(a==80) a= 70; else a = 60; } else pm80 = m80;
_0x2F:
	LDS  R26,_pm80
	LDS  R27,_pm80+1
	SBIW R26,20
...
_0x30:
	...
	STS  _pm80,R30
	STS  _pm80+1,R31
; 0000 0119         if((pm70 - 20) > m70) { if(a==60) a= 50; else a = 40; } else pm70 = m70;
_0x33:
	LDS  R26,_pm70
	LDS  R27,_pm70+1
	SBIW R26,20
...
_0x34:
	...
	STS  _pm70,R30
	STS  _pm70+1,R31
; 0000 011A         if((pm60 - 20) > m60) { if(a==40) a= 30; else a = 20; } else pm60 = m60;
_0x37:
	__GETW2R 13,14
	SBIW R26,20
	CP   R11,R26
...
; 0000 0121 {
; 0000 0122 pm = pm100;
	__GETWRMN 9,10,0,_pm100
; 0000 0123 m = m100;
	__GETWRMN 7,8,0,_m100
; 0000 0124 } ;
_0x40:
; 0000 0125 if (a==80)
	LDI  R30,LOW(80)
...
; 0000 0126 {
; 0000 0127 pm = pm90;
	__GETWRMN 9,10,0,_pm90
; 0000 0128 m = m90;
	__GETWRMN 7,8,0,_m90
; 0000 0129 };
_0x41:
; 0000 012A if (a==60)
	LDI  R30,LOW(60)
...
; 0000 012B {
; 0000 012C pm = pm80;
	__GETWRMN 9,10,0,_pm80
; 0000 012D m = m80;
	__GETWRMN 7,8,0,_m80
; 0000 012E } ;
_0x42:
; 0000 012F if(a==40)
	LDI  R30,LOW(40)
...
; 0000 0130 {
; 0000 0131 pm = pm70;
	__GETWRMN 9,10,0,_pm70
; 0000 0132 m = m70;
	__GETWRMN 7,8,0,_m70
; 0000 0133 };
_0x43:
; 0000 0134 if(a==20)
	LDI  R30,LOW(20)
