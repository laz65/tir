...
; 0000 0110         m100 = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	STS  _m100,R30
	STS  _m100+1,R31
; 0000 0111         m90 = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	STS  _m90,R30
	STS  _m90+1,R31
; 0000 0112         m80 = read_adc(2);
	LDI  R26,LOW(2)
	RCALL _read_adc
	__PUTW1R 13,14
; 0000 0113         m70 = read_adc(3);
	LDI  R26,LOW(3)
	RCALL _read_adc
	__PUTW1R 9,10
; 0000 0114         m60 = read_adc(4);
	LDI  R26,LOW(4)
	RCALL _read_adc
	__PUTW1R 5,6
; 0000 0115         if((pm100 - 20) > m100) a = 100; else pm100 = m100;
	LDS  R26,_pm100
	LDS  R27,_pm100+1
	SBIW R26,20
	LDS  R30,_m100
...
_0x2A:
	...
	STS  _pm100,R30
	STS  _pm100+1,R31
; 0000 0116         if((pm90 - 20) > m90) { if(a==100) a= 95; else a = 90; } else pm90 = m90;
_0x2B:
	LDS  R26,_pm90
	LDS  R27,_pm90+1
	SBIW R26,20
...
_0x2C:
	...
	STS  _pm90,R30
	STS  _pm90+1,R31
; 0000 0117         if((pm80 - 20) > m80) { if(a==90) a= 85; else a = 80; } else pm80 = m80;
_0x2F:
	LDS  R26,_pm80
	LDS  R27,_pm80+1
	SBIW R26,20
...
_0x42:
	...
	RJMP _0x33
_0x30:
	__PUTWMRN _pm80,0,13,14
; 0000 0118         if((pm70 - 20) > m70) { if(a==80) a= 75; else a = 70; } else pm70 = m70;
_0x33:
	__GETW2R 11,12
	SBIW R26,20
	CP   R9,R26
...
; 0000 0119         if((pm60 - 20) > m60) { if(a==70) a= 65; else a = 60; } else pm60 = m60;
_0x37:
	__GETW2R 7,8
	SBIW R26,20
	CP   R5,R26
...
; 0000 011C             timer2 = 0;
	...
	STS  _timer2+2,R30
	STS  _timer2+3,R30
; 0000 011D             while (timer2 < 70000) vivod(a);
_0x3D:
	LDS  R26,_timer2
	LDS  R27,_timer2+1
	LDS  R24,_timer2+2
