...
; 0000 012C         a = 0;
	CLR  R3
	CLR  R4
; 0000 012D         TCCR2B=(0<<WGM22) | (0<<CS22) | (0<<CS21) | (0<<CS20);//Выкл таймер 2
	RCALL SUBOPT_0x7
...
_0x57:
	...
	BRSH _0x58
; 0000 0149         {
; 0000 014A             if((pm90 - 4) > read_adc(1)) if(a==100) a= 90; else a = 80;
	LDS  R30,_pm90
	LDS  R31,_pm90+1
	SBIW R30,4
	PUSH R31
...
_0x5C:
	...
	BRSH _0x5D
; 0000 014D         {
; 0000 014E             if((pm80 - 5) > read_adc(2)) if(a==80) a= 70; else a = 60;
	LDS  R30,_pm80
	LDS  R31,_pm80+1
	SBIW R30,5
	PUSH R31
...
_0x61:
	...
	BRSH _0x62
; 0000 0151         {
; 0000 0152             if((pm70 - 6) > read_adc(3)) if(a==60) a= 50; else a = 40;
	__GETW1R 13,14
	SBIW R30,6
	PUSH R31
	PUSH R30
...
_0x90:
	__PUTW1R 3,4
; 0000 0153         } else pm70 = m70;
_0x63:
	RJMP _0x66
_0x62:
	__MOVEWRR 13,14,11,12
; 0000 0154         if((pm60 - 7) > m60)
_0x66:
	__GETW2R 9,10
	SBIW R26,7
	CP   R7,R26
	...
	BRSH _0x67
; 0000 0155         {
; 0000 0156             if((pm60 - 7) > read_adc(4)) if(a==40) a= 30; else a = 20;
	__GETW1R 9,10
	SBIW R30,7
	PUSH R31
	PUSH R30
...
_0x6B:
	...
	RJMP _0x6C
; 0000 0159         {
; 0000 015A             flag_zvuk = 0;
	CBI  0x1E,0
; 0000 015B             tt1 = 0;
	LDI  R30,LOW(0)
	STS  _tt1,R30
; 0000 015C             TCCR0B=(0<<WGM02) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(1)
	OUT  0x25,R30
; 0000 015D             TCCR2B=(0<<WGM22) | (1<<CS22) | (0<<CS21) | (0<<CS20); // Вкл таймер 2
	LDI  R30,LOW(4)
	STS  177,R30
; 0000 015E             timer2 = 0;
	RCALL SUBOPT_0x4
; 0000 015F             while (timer2 < 150000) vivod(a);
_0x6F:
	RCALL SUBOPT_0x5
	__CPD2N 0x249F0
	BRSH _0x71
...
; 0000 0168             if (kol == 0)
	...
	BRNE _0x7A
; 0000 0169             {
; 0000 016A                 TCCR2B=(0<<WGM22) | (0<<CS22) | (1<<CS21) | (1<<CS20);
	LDI  R30,LOW(3)
	STS  177,R30
; 0000 016B                 r_3 = 0;
	CBI  0x5,2
; 0000 016C                 a = (sum - 200) / 8;
	__GETW1R 5,6
	SUBI R30,LOW(200)
	SBCI R31,HIGH(200)
	CALL __LSRW3
	__PUTW1R 3,4
; 0000 016D                 if (sum == 1000) sum = 999;
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	CP   R30,R5
	CPC  R31,R6
...
_0x7D:
	RCALL SUBOPT_0x4
; 0000 016F                 while (timer2 < 300000) vivod(sum);
_0x7E:
	RCALL SUBOPT_0x5
	RCALL SUBOPT_0x6
	BRSH _0x80
...
; 0000 0177                 timer2 = 0;
	RCALL SUBOPT_0x4
; 0000 0178             }
; 0000 0179             OCR2A=0xFF;
_0x7A:
	LDI  R30,LOW(255)
	STS  179,R30
; 0000 017A             TCCR2B=(0<<WGM22) | (0<<CS22) | (0<<CS21) | (0<<CS20);//Выкл таймер 2
	RCALL SUBOPT_0x7
; 0000 017B             TCCR0B=(0<<WGM02) | (0<<CS02) | (0<<CS01) | (0<<CS00);
; 0000 017C             r_3 = 0;
; 0000 017D             pm100 = read_adc(0);
; 0000 017E             pm90 = read_adc(1);
; 0000 017F             pm80 = read_adc(2);
; 0000 0180             pm70 = read_adc(3);
; 0000 0181             r_3 = 1;
; 0000 0182             pm60 = read_adc(4);
; 0000 0183             sv = 0;
	CBI  0x5,4
; 0000 0184         }
; 0000 0185       }
